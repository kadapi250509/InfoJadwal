...
<nav class="bottom-nav">
    <a href="index.php" class="nav-item active"><i class="fa-solid fa-house"></i><span>Beranda</span></a>
    <a href="jadwal.php" class="nav-item"><i class="fa-solid fa-list"></i><span>Jadwal</span></a>
